...
GRUB considers a pure-exploration variant of this problem that incorporates a similarity graph.
In this variant the goal is to find the best arm in as few samples as possible, and some correlations between the arms are known. \\
...
Specifically, GRUB near-optimally solves the best arm (and -best arm) identification problem in terms of samples taken when a graph indicating the similarity between rewards is available.
